...
1. reversing the string using first function is using slice reverse and the second fuction is of reversing the stirng using for loop.Shown with two methods
    ...
    [CODE](https://github.com/balirampansare/Code-Yard/blob/main/1%20string%20reverse.py)
...
2.
    ...
    [Check out CODE with more descriptive question](https://github.com/balirampansare/Code-Yard/blob/main/2%20unique%20char%20count.py)
